...
INSERT INTO `Objekat`(`IdObj`, `Naziv`, `Adresa`, `Grad`, `PIB`, `TipKuhinje`, `UkOcena`, `BrOcena`, `IdMen`) VALUES
(1, 'Insolita', 'Zorza Klemensoa 27v', 'Beograd', 'pib1', 'italian', 0, 0, 1),
(2, 'City Garden', 'Knez Mihailova 54', 'Beograd', 'pib2', 'serbian', 0, 0, 2),
(3, 'Bahumas Inn', 'Bulevar Nikole Tesle bb', 'Beograd', 'pib3', 'serbian', 0, 0, 1),
(4, 'Inbox', 'Karadjordjeva 9', 'Beograd', 'pib4', 'klub', 0, 0, 3),
(5, 'Witch bar', 'Pariska 13', 'Beograd', 'pib5', 'pab', 0, 0, 3);
